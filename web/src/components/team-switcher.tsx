...
// when available, falls back to the XCT Claw logo for the platform header
...
//   activeAgentId unset   → show "XCT Claw" (platform brand). The dropdown
...
export function AgentSwitcher({
  ...
  const headerLabel = active ? active.name || active.id : "XCT Claw";
